import { faArrowsTurnToDots, faCircleUser, faUserDoctor } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className='dashboard-wrapper'>
            <div className='right'>
                    ...
                    <div className='dr-wrapper'>
                        <div className='dr'>
                            ...
                            <div className='d-flex flex-column ms-2'>
                                <strong>{data?.data?.totalDoctors}</strong>
                            ...
                            <div className='d-flex justify-content-evenly'>
                                    <div>
                                        <div className='d-flex male'>
                                            ...
                                            <span>{data?.data?.doctorGenderCounts?.MALE}</span>
                                        </div>
                                    ...
                                    <div>
                                        <div className='d-flex male'>
                                            ...
                                            <span>{data?.data?.doctorGenderCounts?.FEMALE}</span>
                                        </div>
                                    ...
                                    <div>
                                        <div className='d-flex male'>
                                            ...
                                            <span>{data?.data?.doctorGenderCounts?.OTHERS}</span>
                                        </div>
                ...
                <div className='latest-booking'>
                    ...
                    <div className='booking'>
                        {
                                data?.data?.latestDoctors?.map((app,index)=>(
                                    <div className='booking-wrapper' key={index}> 
                                        <div className='booked'>
                                            <div className='dr-info'>
                                                <div className='dr-img'>
                ...
                <div className='latest-booking'>
                    ...
                    <div className='booking'>
                        {
                                data?.data?.latestPatients?.map((app,index)=>(
                                    <div className='booking-wrapper' key={index}> 
                                        <div className='booked'>
                                            <div className='dr-info'>
                                                <div className='dr-img'>
